...
void text2()
{
	...
	char string2[] = "Pick up the college girl";
	void *font2 = GLUT_BITMAP_TIMES_ROMAN_24;
	int k;
	glColor3f(0.0, 0.0, 0.0);
...
void texti()
{
	...
	char string3[] = "AKHILESH DEVANGA S";
	...
	char string7[] = "Under the guidance of ";
	...
	char string10[] = "Click on the left button to start the show";
